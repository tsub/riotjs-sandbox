...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('todo-app', '<h3>Todos</h3> <todo-list></todo-list>', '', '', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('todo-item', '<span class="done" onclick="{toggle}"> {opts.title} </span>', 'todo-item,[riot-tag="todo-item"],[data-is="todo-item"]{ cursor: pointer; } todo-item .done,[riot-tag="todo-item"] .done,[data-is="todo-item"] .done{ text-decoration: line-through; }', '', function(opts) {
	    this.toggle = () => {
	      alert("hoge");
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('todo-list', '<ul> <li> <todo-item title="hoge"></todo-item> </li> </ul>', '', '', function(opts) {
	});
